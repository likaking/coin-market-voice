...
export default function Home() {
 ...
 //default coin for single coin info
	
  var defaultCoinInfo = [activeCoins[0]].map((c)=>{ return c.id}).toString()
  ...
  //For Playing each coin info *paused* and Preventing set Interval from runing in the control button script
...
detectSpeech()
 ...
 return(
  ...
  <CMVControls currencryMap={currencryMap} coinArr={coinArr} activeCoins={activeCoins} finalComp={finalComp}
   ...
   setPlayCoinInfo={setPlayCoinInfo} paused={paused} setPaused={setPaused} cmvErrorsx={cmvErrorsx} setCmvErrorsx={setCmvErrorsx} 
   cmvAction={cmvAction} setCmvAction={setCmvAction}   />
